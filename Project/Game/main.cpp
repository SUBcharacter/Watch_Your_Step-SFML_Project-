...
int main()
{
	...
	platform.push_back(new Platform("Assets/platform_static.png", STATIC, { 1062.5, 5925.0 }, 0, 0, 325, 25));
	platform.push_back(new Platform("Assets/platform_static.png", STATIC, { 1537.5, 5925.0 }, 0, 0, 325, 25));
	platform.push_back(new Platform("Assets/platform_static.png", STATIC, { 1300, 6700 }, 0, 0, 800, 25));
	platform.push_back(new JumpPlatform("Assets/platform_jump1.png", JUMP, { 1220, 625  }, 370, 0, 60 , 25, 600.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump1.png", JUMP, { 1670, 525  }, 370, 0, 60 , 25, 600.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump3.png", JUMP, { 1005, 1050 }, 370, 0, 60 , 25, 1800.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump2.png", JUMP, { 1530, 1070 }, 260, 0, 280, 25, 1200.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump2.png", JUMP, { 1340, 1120 }, 370, 0, 60 , 25, 1200.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump2.png", JUMP, { 1430, 1400 }, 370, 0, 60 , 25, 1200.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump3.png", JUMP, { 1065, 1870 }, 370, 0, 60 , 25, 1800.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump3.png", JUMP, { 1450, 1990 }, 250, 0, 300, 25, 1800.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump2.png", JUMP, { 1585, 1890 }, 365, 0, 70 , 25, 1200.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump3.png", JUMP, { 1655, 1590 }, 370, 0, 60 , 25, 1800.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump3.png", JUMP, { 1625, 2190 }, 325, 0, 150, 25, 1800.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump1.png", JUMP, { 1340, 2290 }, 370, 0, 60 , 25, 600.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump3.png", JUMP, { 1240, 2640 }, 160, 0, 480, 25, 1800.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump4.png", JUMP, { 1030, 2390 }, 370, 0, 60 , 25, 2400.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump2.png", JUMP, { 1030, 2515 }, 370, 0, 60 , 25, 1200.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump3.png", JUMP, { 1110, 2760 }, 325, 0, 150, 25, 1800.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump3.png", JUMP, { 1380, 2880 }, 325, 0, 150, 25, 1800.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump3.png", JUMP, { 975 , 3000 }, 325, 0, 150, 25, 1800.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump3.png", JUMP, { 1560, 3100 }, 325, 0, 150, 25, 1800.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump3.png", JUMP, { 1240, 3200 }, 325, 0, 150, 25, 1800.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump3.png", JUMP, { 1110, 3310 }, 325, 0, 150, 25, 1800.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump3.png", JUMP, { 1480, 3310 }, 325, 0, 150, 25, 1800.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump2.png", JUMP, { 1205, 3630 }, 365, 0, 70 , 25, 1200.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump1.png", JUMP, { 1357, 3790 }, 365, 0, 70 , 25, 600.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump4.png", JUMP, { 1153, 3990 }, 365, 0, 70 , 25, 2400.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump3.png", JUMP, { 1370, 4065 }, 365, 0, 70 , 25, 1800.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump5.png", JUMP, { 1306, 4210 }, 365, 0, 70 , 25, 3000.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump3.png", JUMP, { 1252, 4450 }, 365, 0, 70 , 25, 1800.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump3.png", JUMP, { 1170, 5000 }, 350, 0, 100, 25, 1800.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump3.png", JUMP, { 1054, 5120 }, 350, 0, 100, 25, 1800.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump3.png", JUMP, { 1433, 5107 }, 350, 0, 100, 25, 1800.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump3.png", JUMP, { 1220, 5257 }, 350, 0, 100, 25, 1800.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump4.png", JUMP, { 1650, 5400 }, 350, 0, 100, 25, 2400.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump1.png", JUMP, { 1600, 5560 }, 375, 0, 50 , 25, 600.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump1.png", JUMP, { 1400, 5560 }, 375, 0, 50 , 25, 600.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump1.png", JUMP, { 1200, 5560 }, 375, 0, 50 , 25, 600.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump1.png", JUMP, { 1000, 5560 }, 375, 0, 50 , 25, 600.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump3.png", JUMP, { 1225, 5775 }, 75 , 0, 700, 25, 1800.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump5.png", JUMP, { 1065, 6500 }, 235, 0, 330, 25, 3000.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump5.png", JUMP, { 1535, 6500 }, 235, 0, 330, 25, 3000.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump4.png", JUMP, { 1358, 6016 }, 375, 0, 50, 25, 2400.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump4.png", JUMP, { 1227, 6065 }, 375, 0, 50, 25, 2400.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump4.png", JUMP, { 1431, 6161 }, 375, 0, 50, 25, 2400.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump4.png", JUMP, { 1317, 6215 }, 375, 0, 50, 25, 2400.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump4.png", JUMP, { 1189, 6317 }, 375, 0, 50, 25, 2400.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump4.png", JUMP, { 1400, 6356 }, 375, 0, 50, 25, 2400.f));
	platform.push_back(new JumpPlatform("Assets/platform_jump4.png", JUMP, { 1259, 6427 }, 375, 0, 50, 25, 2400.f));
